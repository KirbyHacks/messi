        ...
        if (args[0]) {
            ...
            if (comando) {
                let embed = new Discord.EmbedBuilder()
                    ...
                    .setFooter({ text: `© desarrollado por ! rLøw#7628 | 2022`, iconURL: `https://media.discordapp.net/attachments/1053010509802242071/1053525749648326777/images.png?size=4096` })
            ...
            .setColor(client.color)
            .setDescription(`Bot Multifuncional en desarrollo por \`! rLøw#7628\``)
            ...
            .addFields([{name: `📈 **__ESTADÍSTICAS__**`, value: `⚙ **${client.commands.size} Comandos**\n📁 en **${client.guilds.cache.size} Servidores**\n📶 **\`${client.ws.ping}ms\` Ping**\n👤 desarrollado por **[! rLøw#7628](https://github.com/KirbyHacks)**`}], )
            .setThumbnail(message.guild.iconURL({ dynamic: true }))
            .setFooter({ text: `Página 1 / ${categorias.length+1}\n© desarrollado por ! rLøw#7628 | 2022`, iconURL: `https://media.discordapp.net/attachments/1053010509802242071/1053525749648326777/images.png?size=4096` })
